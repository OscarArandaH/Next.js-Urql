...
const PDFPage = () => {
  ...
  return (
    <div>
      <button style={{backgroundColor: 'blue', color: 'white', padding: '1rem', borderRadius: '1rem'}} onClick={() => instance.url && window.open(instance.url, '_blank')}>Open in new tab</button>
      {/* <a href={instance.url} target="_blank" rel="noopener noreferrer">Open in new tab</a> */}
    </div>
